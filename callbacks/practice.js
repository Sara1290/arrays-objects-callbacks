...
//Code Here
function multiply(numOne, numTwo, cbFunc) {
  return cbFunc(numOne * numTwo)
}
cbFunc(3,4)
...
function getUserById(users, anId, callBack){
  for(let b = 0; b < users.length; b++){
    if (users[b].id === anId){
      return callBack(users[b])
    }
  }
}
